    ...
    <>
      ...
      <Dialog.Root open={open} onOpenChange={setOpen} modal={true}>
        <Dialog.Portal>
          ...
          <Dialog.Popup className="bg-surface fixed inset-x-0 bottom-0 z-[70] flex flex-col transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] data-[ending-style]:translate-y-full data-[starting-style]:translate-y-full">
            {/* Header */}
